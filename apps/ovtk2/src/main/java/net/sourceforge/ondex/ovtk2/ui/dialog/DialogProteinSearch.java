 ...
 * @version 14.07.2008
 */
public class DialogProteinSearch extends OVTK2Dialog implements
	 ...
	 *            search stringe
	 */
	public DialogProteinSearch(OVTK2Viewer viewer, String s) {
		...
		IndeterminateProcessAdapter p = new IndeterminateProcessAdapter() {
			public void task() {
				...
				try {
					...
					properties
							.add(new JLabel("UniProt Error while searching."));
