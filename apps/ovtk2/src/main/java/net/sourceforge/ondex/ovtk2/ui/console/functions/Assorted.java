...
/**
 * A collection of application specific functions not worthy of a separate
 * class file.
 * 
 * 
 * @author lysenkoa
...
public class Assorted {
	...
	/**
	 * Kegg pathway reduction. Remove all of the pathways that do not contain at least one 
	 * concept of the specified context. Create a pathway context for all of the remaining
	 * pathways with an appropriate path concept as a container.
	 */
