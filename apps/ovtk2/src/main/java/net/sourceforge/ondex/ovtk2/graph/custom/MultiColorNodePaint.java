 ...
 * 
 */
public class MultiColorNodePaint implements Paint {
	 ...
	 *            ordered colours
	 */
	public MultiColorNodePaint(Color[] colors) {
		this.colors = colors;
	}
	...
	public PaintContext createContext(ColorModel cm, Rectangle deviceBounds,
		...
		Point2D dStart = new Point2D.Double(userBounds.getX(), userBounds
				.getY());
		Point2D dEnd = new Point2D.Double(userBounds.getX(), userBounds.getY()
