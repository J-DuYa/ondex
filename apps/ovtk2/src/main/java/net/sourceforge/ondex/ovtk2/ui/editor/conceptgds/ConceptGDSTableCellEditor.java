...
/**
 * Using a text field to edit the XML string of a concept Attribute.
 *
 * @author taubertj
 */
public class ConceptGDSTableCellEditor extends DefaultCellEditor implements
        MouseListener, CaretListener {

    /**
     * generated
     */
    private static final long serialVersionUID = -7503539291654626713L;
     ...
     */
    public ConceptGDSTableCellEditor(ONDEXGraph graph) {
    ...
    public Component getTableCellEditorComponent(JTable table, Object value,
        ...
        // which concept and attribute name we are working on
        ...
        if (editorValue.trim().length() > 0) {
            ...
            if (validEntry) {
                ...
                if (attribute == null) {
                    ...
                    attribute = concept.createAttribute(an, o, false);
                } else {
            ...
            if (attribute != null) {
                // delete concept Attribute for empty string editor value
                concept.deleteAttribute(an);
                attribute = null;
            }
        }

        // return concept Attribute instead of string
        return attribute;
    }
