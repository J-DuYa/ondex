...
/**
 * This class controls the configuration of the console and which of the avaible interpreter should be used: e.g.
 * Javascript, Jython, R.
 *
 * @author lysenkoa
 */
...
//		else if(command.equalsIgnoreCase("R_MODE;")||command.equalsIgnoreCase("R_MODE")){
//			try {
...
//		else if(command.equalsIgnoreCase("GQL_MODE;")||command.equalsIgnoreCase("GQL_MODE")){
//			try {
//				out.print("Changing configuaration - please wait...");
//				ic.setInterpreterOrder(this.getClass(), OndexGQLInterpreter.class, JSInterpreter.class);
//				if(DEBUG){
...
//		else if(command.equalsIgnoreCase("JYTHON_MODE;")||command.equalsIgnoreCase("JYTHON_MODE")){
//			try {
//				out.print("Changing configuaration - please wait...");
