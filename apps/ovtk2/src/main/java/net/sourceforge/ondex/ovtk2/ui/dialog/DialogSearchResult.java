 ...
 * @version 14.07.2008
 */
public class DialogSearchResult extends OVTK2Dialog implements
	 ...
	 */
	public DialogSearchResult(OVTK2Viewer viewer, String s, boolean isRegex,
			boolean isCaseSensitive, ConceptClass conceptClass,
			DataSource dataSource, ONDEXConcept context) {
