...
/**
 * This is a {@link JPanel} to edit the contents of a {@link CustomPopupItemBean} object.<br>
...
public class PopupItemEditPanel extends javax.swing.JPanel implements ItemEditHandler {
    ...
    // soft linking to jedit.jar -- user needs to download that jar manually and put it into lib/
    private void initJEditTextArea() {
    	...
    	try {
			...
			// this is for: customPopupCodeJEditTextArea.getBuffer().setProperty("folding", "indent");
			classJEditBuffer.getMethod("setProperty", String.class, Object.class).invoke(
					classTextArea.getMethod("getBuffer").invoke(customPopupCodeComponent),
					"folding", "indent");
			...
			classModeProvider.getMethod("addMode", classMode).invoke(
					classModeProvider.getDeclaredField("instance").get(null),
					mode);
			// this is for: customPopupCodeJEditTextArea.getBufer().setMode(mode);
			classJEditBuffer.getMethod("setMode", classMode).invoke(
					classTextArea.getMethod("getBuffer").invoke(customPopupCodeComponent),
					mode);
    ...
    private void setCodeText(String code) {
    	if(customPopupCodeComponent==null) {
    		...
    		try {
				Class.forName("org.gjt.sp.jedit.textarea.TextArea")
				.getMethod("setText", String.class).invoke(customPopupCodeComponent, code);
			} catch (Exception e) {
				e.printStackTrace();
			}
    	}
	...
	private String getCodeText() {
		...
		try {
			return (String)
			Class.forName("org.gjt.sp.jedit.textarea.TextArea")
			.getMethod("getText").invoke(customPopupCodeComponent);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(conceptClassesTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 668, Short.MAX_VALUE)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(jLabel1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(librariesTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 611, Short.MAX_VALUE))
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(conceptClassesTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(11, 11, 11)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(librariesTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(customPopupCodeScrollPane, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 696, Short.MAX_VALUE))
        );
        jPanel7Layout.setVerticalGroup(
            jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 408, Short.MAX_VALUE)
            .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(customPopupCodeScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 408, Short.MAX_VALUE))
        );
