...
public interface ItemEditHandler {
    ...
    /** set changed flag
     * When implementing this interface, you should only care about setting the flag true when a change occours.
     */
	...
	/** no item should be edited now, such that, for instance, {@link #getItemName()} does return null */
