...
public class Artifact implements Comparable<Artifact> {
    ...
    /**
     * @param artifactElement a nexus jdom xml artifact element
     */
    ...
    public String toResourceURL() {
        return NexusURLs.NEXUS_SERVICE + "/local/artifact/maven/redirect?" +
                "r=" + getRepoId() +
                "&g=" + getGroupId() +
                "&a=" + getArtifactId() +
                "&v=" + getVersion() +
    ...
    public int compareTo(Artifact o) {
        return (getGroupId() + "_" + getArtifactId() + "_" + getVersion())
                .compareTo(o.getGroupId() + "_" + o.getArtifactId() + "_" + o.getVersion());
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Artifact) {
            ...
            return (getGroupId() + "_" + getArtifactId() + "_" + getVersion())
                    .equals(art.getGroupId() + "_" + art.getArtifactId() + "_" + art.getVersion());
        }
        return false;
    }
