...
/**
 * this is the panel of the statistics module that displays the 
 * results of the analysis, i.e. the number of relevant concepts
 * the number of relevant relations, the average value, the 
 * standard deviation and the histogram for the dataset. 
 * It also provides a Slider that allows for the adjustment of
 * the quantification interval length (i.e. the resolution).
 * 
 * 
...
public class DisplayPanel extends JPanel implements ChangeListener{
	...
	/**
	 * labels for the number of concepts, number of relations, average and std deviation.
	 */
	...
	/**
	 * constructor. sets up the standard layout and
	 * adds all components.
	 */
	...
	/**
	 * updates the complete analysis. all values are recalculated
	 * and the results displayed. the analysis runs in a separate
	 * thread that is monitored by a progressbar, which is displayed
	 * instead of the chart until the computation is done.
	 */
...
//				try {Thread.sleep(500);} catch (InterruptedException e) {}
	...
	/**
	 * called whenever the slider was moved. it then reads out
	 * the desired resolution and repeats the analysis.
	...
	/**
	 * @return the length of the quantification interval as 
	 * chosen by the user.
	 */
	 ...
	 * @param r the number of relations.
	 */
