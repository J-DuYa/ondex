...
SectionGroup "Ondex Integrator"
	...
	Section "Integrator CytoscapeJS JSON plug-in" SecOndexCytoJSON
	
	    SetOutPath $INSTDIR
	    SetOverwrite on
	
	    ;ADD YOUR OWN FILES HERE...
	    File "/oname=$INSTDIR\plugins\cytoJSON-jar-with-dependencies.jar" "${PROJECT_BUILD_DIR}\plugins\cyjs_json-jar-with-dependencies.jar"
...
;Descriptions
  	...
  	LangString DESC_SecOndexCytoJSON ${LANG_ENGLISH} "CytoscapeJS_JSON functionality plugin-in for Integrator."
  	...
  	!insertmacro MUI_DESCRIPTION_TEXT ${SecOndexCytoJSON} $(DESC_SecOndexCytoJSON)
...
Function .onInit
  ...
  !insertmacro SelectSection ${SecOndexCytoJSON}
