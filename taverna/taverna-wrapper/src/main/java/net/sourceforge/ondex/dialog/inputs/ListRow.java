...
class ListRow extends AbstractRow implements DocumentListener, ListSelectionListener, PropertyChangeListener{
    ...
    private JFormattedTextField addDelimiterField(int column, int row, int gridWidth, int gridHeight) 
    ...
    private void enterURI() throws MalformedURLException, IOException{
        clearPervious();
        uri = JOptionPane.showInputDialog(parentGui.getParent(), "Please enter a URI including Schema(http:)", "URI to List", 
