 ...
 * @author taubertj
 */
@Status(description = "Only tested with LycoCyc so far", status = StatusType.EXPERIMENTAL)
@DatabaseTarget(name = "BioCyc", description = "BioCyc databases", version = "BioPax version 2", url = "http://www.biocyc.org")
@DataURL(name = "BioCyc databases",
        description = "Place .owl file in data folder with no directory structure",
        urls = {""})
public class Parser extends ONDEXParser
{
     ...
     *
     * @param file File for translation.tab
     * @throws Exception
     */
    ...
    public void start() throws Exception {
        ...
        File file = new File(dir.getParent() + File.separator + "translation.tab");
        ...
        new PhysicalEntityHandler(this.graph, m.getObjects(physicalEntity.class));
        ...
        fireEventOccurred(new GeneralOutputEvent(
                "Adding controls finished.", "[Parser - start]"));
