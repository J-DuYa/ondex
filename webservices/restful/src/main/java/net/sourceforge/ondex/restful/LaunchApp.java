...
public class LaunchApp {
	...
	protected static SelectorThread startServer() throws IOException {
		...
		initParams.put("com.sun.jersey.config.property.packages",
				"net.sourceforge.ondex.restful.resources" + ";"
						+ "net.sourceforge.ondex.restful.resources.writers"
						+ ";"
						+ "net.sourceforge.ondex.restful.resources.readers"
						+ ";"
						+ "net.sourceforge.ondex.restful.resources.injectable");
	...
	public static void main(String[] args) throws IOException {
		if (args.length == 0) {
			System.out
					.println("Usage: java -jar restful.jar LaunchApp PathToOXLFiles");
			return;
		}
