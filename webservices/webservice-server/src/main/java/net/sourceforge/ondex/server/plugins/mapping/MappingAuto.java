...
*/
public class MappingAuto extends Base{ 

    private static final Logger logger = Logger.getLogger(MappingAuto.class);

    public MappingAuto() throws CaughtException{
        super();
    }
...
//Ignoring plugin without status mapping inferGoTerm
     ...
     * @return String representation of all event fired by the mapping
    ...
    public String inparanoidMapping(
        ...
        try{
           ...
           return runMapping(graph, mapping, arguments);
