...
public class SOAPONDEXGraphMetaData implements ONDEXGraphMetaData {
	...
	public AttributeName createAttributeName(String id, String fullname,
		...
		try {
			...
			if (specialisationOf != null)
				specialisationOfId = specialisationOf.getId();
			String unitId = null;
			if (unit != null)
				unitId = unit.getId();
			soapGraph.createAttributeName(graphId, id, fullname, description,
					unitId, datatype.getName(), specialisationOfId);
	...
	public DataSource createDataSource(String id, String fullname, String description) {
		try {
			soapGraph.createDataSource(graphId, new Holder<String>(id), fullname,
					description);
	...
	public ConceptClass createConceptClass(String id, String fullname,
		...
		try {
			...
			if (specialisationOf != null)
				specialisationOfId = specialisationOf.getId();
			soapGraph.createConceptClass(graphId, new Holder<String>(id),
					fullname, description, specialisationOfId);
	...
	public EvidenceType createEvidenceType(String id, String fullname,
			String description) {
		try {
			soapGraph.createEvidenceType(graphId, new Holder<String>(id),
	...
	public RelationType createRelationType(String id, String fullname,
		...
		try {
			...
			if (specialisationOf != null)
				specialisationOfId = specialisationOf.getId();
			soapGraph.createRelationType(graphId, new Holder<String>(id),
					fullname, description, inverseName, isAntisymmetric,
					isReflexive, isSymmetric, isTransitiv, specialisationOfId);
	...
	public Unit createUnit(String id, String fullname, String description) {
		try {
			soapGraph.createUnit(graphId, new Holder<String>(id), fullname,
					description);
	...
	public AttributeName getAttributeName(String id) {
		try {
			if (soapGraph.getAttributeName(graphId, id) != null)
				return new SOAPAttributeName(parent, id);
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public Set<AttributeName> getAttributeNames() {
		...
		try {
			for (WSAttributeName wsan : soapGraph.getAttributeNames(graphId)
					.getWSAttributeName()) {
	...
	public DataSource getDataSource(String id) {
		try {
			if (soapGraph.getDataSource(graphId, id) != null)
				return new SOAPDataSource(parent, id);
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public ConceptClass getConceptClass(String id) {
		try {
			if (soapGraph.getConceptClass(graphId, id) != null)
				return new SOAPConceptClass(parent, id);
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public Set<ConceptClass> getConceptClasses() {
		...
		try {
			for (WSConceptClass wscc : soapGraph.getConceptClasses(graphId)
					.getWSConceptClass()) {
	...
	public EvidenceType getEvidenceType(String id) {
		try {
			if (soapGraph.getEvidenceType(graphId, id) != null)
				return new SOAPEvidenceType(parent, id);
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public Set<EvidenceType> getEvidenceTypes() {
		...
		try {
			for (WSEvidenceType wset : soapGraph.getEvidenceTypes(graphId)
					.getWSEvidenceType()) {
	...
	public RelationType getRelationType(String id) {
		try {
			if (soapGraph.getRelationType(graphId, id) != null)
				return new SOAPRelationType(parent, id);
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public Set<RelationType> getRelationTypes() {
		...
		try {
			for (WSRelationType wsrt : soapGraph.getRelationTypes(graphId)
					.getWSRelationType()) {
	...
	public Unit getUnit(String id) {
		try {
			if (soapGraph.getUnit(graphId, id) != null)
				return new SOAPUnit(parent, id);
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
