...
public class SOAPRelationType implements RelationType {
	...
	public String getDescription() {
		try {
			return soapGraph.getRelationType(graphId, id).getDescription()
					.getValue();
	...
	public String getFullname() {
		try {
			return soapGraph.getRelationType(graphId, id).getFullname()
					.getValue();
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public String getInverseName() {
		try {
			return soapGraph.getRelationType(graphId, id).getInverseName()
					.getValue();
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public RelationType getSpecialisationOf() {
		String rtid;
		try {
			rtid = soapGraph.getRelationType(graphId, id).getSpecialisationOf()
					.getValue();
			if (rtid != null && rtid.length() > 0)
				return new SOAPRelationType(parent, rtid);
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
		}
	...
	public boolean isAntisymmetric() {
		try {
			return soapGraph.getRelationType(graphId, id).isAntisymmetric()
					.booleanValue();
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public boolean isReflexive() {
		try {
			return soapGraph.getRelationType(graphId, id).isReflexive()
					.booleanValue();
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public boolean isSymmetric() {
		try {
			return soapGraph.getRelationType(graphId, id).isSymmetric()
					.booleanValue();
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public boolean isTransitiv() {
		try {
			return soapGraph.getRelationType(graphId, id).isTransitiv()
					.booleanValue();
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public void setAntisymmetric(boolean isAntisymmetric) {
		try {
			soapGraph.getRelationType(graphId, id).setAntisymmetric(
					isAntisymmetric);
		} catch (WebserviceException_Exception e) {
			parent.fireActionEvent(e, e.getMessage());
			e.printStackTrace();
	...
	public void setDescription(String description) {
		try {
			JAXBElement<String> old = soapGraph.getRelationType(graphId, id)
					.getDescription();
