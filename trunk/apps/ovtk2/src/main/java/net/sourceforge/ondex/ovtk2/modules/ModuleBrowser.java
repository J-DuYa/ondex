...
public class ModuleBrowser extends javax.swing.JFrame implements ActionListener {
    ...
    private void initComponents() throws JDOMException, IOException {
        ...
        for (Artifact artifact : artifacts) {
            ...
            //String xml = convertStreamToString(pluginDescriptor.getXML(artifact));
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(Alignment.TRAILING, false)
                                ...
                                .addComponent(jScrollPane1, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE))
                        .addPreferredGap(ComponentPlacement.RELATED)
