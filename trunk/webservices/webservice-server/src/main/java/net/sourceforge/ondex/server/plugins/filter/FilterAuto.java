/* Webservice wrapper of the Filterplugins.
*
*/
...
*/
public class FilterAuto extends Base{ 
...
//Ignoring plugin without status filter accessionregex
//Ignoring plugin without status filter allpairs
//Ignoring plugin without status filter attributevalue
//Ignoring plugin without status filter cloner
     /**
    ...
    public WSFilterResult conceptclassFilter(
           @WebParam(name = "TargetConceptClass")java.lang.String[] TargetConceptClass,
           @WebParam(name = "cv_to_filter")java.lang.String cv_to_filter,
           @WebParam(name = "acc_file")java.lang.String acc_file,
           @WebParam(name = "Exclude")java.lang.Boolean Exclude,
           @WebParam(name = "graphId") Long graphId)
           throws WebserviceException {
        try{
           logger.info("filter conceptclass called");
           net.sourceforge.ondex.filter.conceptclass.Filter filter =
                   new net.sourceforge.ondex.filter.conceptclass.Filter();
...
//Ignoring discontinuted plugin filter conceptclassneighbours
//Ignoring plugin without status filter datasource
//Ignoring experimental plugin filter ec_hierarchies
//Ignoring plugin without status filter evidencetype
//Ignoring plugin without status filter genomicBackend
//Ignoring plugin without status filter isolateclusters
//Ignoring plugin without status filter nohits
//Ignoring plugin without status filter onepairshortestpath
//Ignoring plugin without status filter pfambasedortholog
//Ignoring plugin without status filter relationneighbours
//Ignoring plugin without status filter relationtype
//Ignoring plugin without status filter relationtypemissing
//Ignoring plugin without status filter shortestpath
     /**
    ...
    @WebMethod(exclude = false)
    public WSFilterResult significanceFilter(
           @WebParam(name = "TargetAttributeName")java.lang.String TargetAttributeName,
           @WebParam(name = "Significance")java.lang.Double Significance,
           @WebParam(name = "Inverse")java.lang.Boolean Inverse,
           @WebParam(name = "AbsoluteValues")java.lang.Boolean AbsoluteValues,
           @WebParam(name = "Remove_no_att")java.lang.Boolean Remove_no_att,
           @WebParam(name = "ConceptMode")java.lang.Boolean ConceptMode,
           @WebParam(name = "graphId") Long graphId)
           throws WebserviceException {
        try{
           logger.info("filter significance called");
           net.sourceforge.ondex.filter.significance.Filter filter =
                   new net.sourceforge.ondex.filter.significance.Filter();
           logger.info(");Filter created "+filter);
           ONDEXGraph graph = webServiceEngine.getGraphToEdit(graphId);
           logger.info("found graph");
           ONDEXPluginArguments arguments = new ONDEXPluginArguments(filter.getArgumentDefinitions());
...
//Ignoring plugin without status filter spanningtree
//Ignoring plugin without status filter subgraph
//Ignoring plugin without status filter tag
//Ignoring plugin without status filter tagconsensus
//Ignoring plugin without status filter transitive
     /**
    ...
    @WebMethod(exclude = false)
    public WSFilterResult unconnectedFilter(
           @WebParam(name = "RemoveTagDependencies")java.lang.Boolean RemoveTagDependencies,
           @WebParam(name = "ConceptClassRestriction")java.lang.String[] ConceptClassRestriction,
           @WebParam(name = "graphId") Long graphId)
           throws WebserviceException {
        try{
           logger.info("filter unconnected called");
           net.sourceforge.ondex.filter.unconnected.Filter filter =
                   new net.sourceforge.ondex.filter.unconnected.Filter();
           logger.info(");Filter created "+filter);
           ONDEXGraph graph = webServiceEngine.getGraphToEdit(graphId);
           logger.info("found graph");
           ONDEXPluginArguments arguments = new ONDEXPluginArguments(filter.getArgumentDefinitions());
