...
*/
public class ParserUsingJobAuto extends JobBase{ 

    private static final Logger logger = Logger.getLogger(ParserUsingJobAuto.class);

    public ParserUsingJobAuto() throws CaughtException{
        super();
    }
...
If your file type is not in this list, please try "simple" as this parser is the most generic
    ...
    public String FASTAParser(
        ...
        try{
           ...
           ParserJob job = new ParserJob(graph, parser, arguments);
...
//Ignoring experimental plugin parser arabidopsis_hormone_db
     ...
     *
 	 ...
 	 *    DatabaseTarget: AraCyc http://www.genome.jp/kegg The AraCyc database [Ljava.lang.String;@616364
 	 *    DataURL: AraCyc databases URL on application to AraCyc all files in data folder with no directory structure [Ljava.lang.String;@1c46bab
...
//Ignoring plugin without status parser barrescelltype
     ...
     *
 	 *    DatabaseTarget: BCSDB http://www.glyco.ac.ru/bcsdb3 Bacterial Carbohydrate Structure DataBase [Ljava.lang.String;@78b4c4
...
//Ignoring experimental plugin parser brenda
     ...
     *
 	 *    DatabaseTarget: BRENDA http://www.brenda-enzymes.info/ Brenda enzymatics database [Ljava.lang.String;@a3c7b1
...
//Ignoring plugin without status parser drastic
     ...
     *
 	 *    Status: STABLE Tested March 2010 (Artem Lysenko)
 	 *    DatabaseTarget: EXPASY ENZYME http://www.expasy.ch/ EXPASY ENZYME database [Ljava.lang.String;@8b7250
 	 *    DataURL: enzclass and enzyme files enzclass and enzyme, all txt and dat files in directory files [Ljava.lang.String;@fe210a
...
//Ignoring plugin without status parser fulltext
     ...
     *
 	 ...
 	 *    DatabaseTarget: GOA http://geneontology.org/GO.format.annotation.shtml Gene Association Files (GAF) [Ljava.lang.String;@2b452b
 	 *    DataURL: GAF files Any GAF file, e.g gene annotations to GO, PO or TO. [Ljava.lang.String;@ca1465
 	 *    Custodians: Keywan Hassani-pak, 
     * @param InputFileString
 	 *            (REQUIRED!) (Use this or InputFileByteArray NOT BOTH.) Absolute path to input file
     *        Legal values for the String are:
...
//Ignoring plugin without status parser genego
     ...
     *
 	 ...
 	 *    DatabaseTarget: GenericOBO http://www.obofoundry.org/ A parser for the OBO format. Currently it understands GO, PO, TO, CHEBI dialects. [Ljava.lang.String;@10105c1
 	 *    DataURL: OBO It works with Plant Ontology, Ttrait Ontology, Gene Ontology and CHEBI [Ljava.lang.String;@20ea6c
 	 *    Custodians: Keywan Hassani-pak, 
     * @param OboType
...
//Ignoring plugin without status parser glycomedb
     ...
     *
 	 ...
 	 *    Authors: Keywan Hassani-Pak, 
 	 *    DatabaseTarget: GO http://www.geneontology.org/ A parser for the Gene Ontology. [Ljava.lang.String;@fe7f80
 	 *    DataURL: GO GO Filtered ontology; cross-products, inter-ontology links, and has_part relationships removed [Ljava.lang.String;@64af0f
 	 *    Custodians: Keywan Hassani-pak, 
     * @param Obsoletes
 	 *            (Optional. Defaults to :false) This specifies if OBO-concepts with the obsolete flag will be parsed.
     * @param IsGOSLIM
...
//Ignoring experimental plugin parser interpro
     ...
     *
 	 ...
 	 *    DatabaseTarget: KEGG http://www.genome.jp/kegg The KEGG database [Ljava.lang.String;@213339
 	 *    DataURL: KEGG genes, ligand, pathway, and brite databases  [Ljava.lang.String;@1aa1db8
     ...
     *
 	 ...
 	 *    DatabaseTarget: KEGG http://www.genome.jp/kegg The KEGG database [Ljava.lang.String;@1854d1f
 	 *    DataURL: KEGG databases KEGG genes, ligand, pathway, and brite databases. keggHierarchy file is optional and adds a shallow hierarchy of super pathways. [Ljava.lang.String;@8a6351
 	 *    Authors: Matthew Hindle, Jan Taubert, 
 	 *    Custodians: Shaochih Kuo, 
     * @param InputDirString
 	 *            (REQUIRED!) (If InputDirByteArray is used the this will only serve to determine compression type.) Absolute path to input directory
     ...
     *
 	 ...
 	 *    DatabaseTarget: KEGG http://www.genome.jp/kegg The KEGG database [Ljava.lang.String;@17e8c5b
 	 *    DataURL: KEGG databases KEGG genes, ligand, pathway, and brite databases. keggHierarchy file is optional and adds a shallow hierarchy of super pathways. [Ljava.lang.String;@130b97d
 	 *    Authors: Matthew Hindle, Jan Taubert, 
 	 *    Custodians: Shaochih Kuo, 
     * @param InputDirString
 	 *            (REQUIRED!) (If InputDirByteArray is used the this will only serve to determine compression type.) Absolute path to input directory
...
//Ignoring plugin without status parser matrix
     ...
     *
 	 ...
 	 *    Authors: Keywan Hassani-Pak, 
 	 *    DatabaseTarget: MEDLINE http://www.ncbi.nlm.nih.gov/pubmed/ Biomedical Literature [Ljava.lang.String;@1e1ee5d
 	 *    DataURL: MEDLINE XML Any MEDLINE XML file. Use either PubMed to search for keywords and save results to XML or use Parser's integrated web-service functionality to fetch cited publications online. [Ljava.lang.String;@1e85928
 	 *    Custodians: Keywan Hassani-pak, 
     * @param InputFileString
...
//Ignoring experimental plugin parser transpath
     ...
     *
 	 ...
 	 *    DatabaseTarget: UniProt http://www.uniprot.org A comprehensive, high-quality and freely accessible resource of protein sequence and functional information. [Ljava.lang.String;@1ba0281
 	 *    DataURL: UniProt XML Any UniProt (Swiss-Prot or TrEMBL) XML file, avoid parsing everything if possible, select your species in UniProt and download a subset. [Ljava.lang.String;@fa6824
 	 *    Custodians: Keywan Hassani-pak, 
     * @param InputFileString
